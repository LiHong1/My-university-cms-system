...
<frameset cols="*,1035,*"  border="0" frameborder="0" framespacing="0" scrolling="no" >
	...
	<frameset rows="110,*" frameborder="0" noresize frameSpacing="0">
		<frame name="top" src="<%=request.getContextPath() %>/jsp/admin/top.jsp" frameborder="0" framespacing="0" scrolling="no">
