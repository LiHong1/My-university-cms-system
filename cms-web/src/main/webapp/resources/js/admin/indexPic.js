$(function(){
	...
	$("#indexPic").uploadify({
		...
		uploader:ctx+"/admin/pic/uploadIndexPic;jsessionid=" + $("#sid").val(),
		fileObjName:"pic",
		multi:false,
		formData:{"sid":$("#sid").val()},
		fileTypeExts:"*.jpg;*.png;",
		onUploadSuccess:function(file, data, response) {
			var indexPic = $.parseJSON(data);
			var ao=indexPic.indexPic;
			if(ao.result) {
				...
				$("#indexPicView img").Jcrop({
					aspectRatio:indexPicWidth/indexPicHeight,//宽高的比例
					onChange: showPreview,
					onSelect: showPreview,
					setSelect: [0,0,indexPicWidth,indexPicHeight] //默认选择
				});
